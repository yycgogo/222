...
<html class="x-admin-sm">
    ...
    <div class="x-body">
        <blockquote class="layui-elem-quote">欢迎管理员：
            <span class="x-red"><shiro:user><shiro:principal></shiro:principal></shiro:user></span>！当前时间:2019-04-17 13:00  <a onclick="parent.x_admin_add_to_tab('在tab打开','https://www.163.com',true)" style="color: red" href="javascript:;">在tab打开</a>
        </blockquote>
